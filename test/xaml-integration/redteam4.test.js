...
// Round 4 red-team probes: adjacent Style/Template semantics that real WinUI authors hit after
// TargetType and Setter.Property completion start working.
...
describe("WinUI XAML red-team 4 — markup extensions beyond StaticResource", function () {
  ...
  it("ThemeResource key completion matches StaticResource for app and framework keys", async () => {
    // Background is a Brush: app key always offered + a framework theme BRUSH key offered (type-scoped, round 74).
