...
// Round 3 red-team probes: style/template authoring, awkward attribute positions,
// custom namespace user controls, x:DataType x:Bind, and malformed-input robustness.
