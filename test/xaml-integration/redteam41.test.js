...
// Round 41 red-team probes for WinUI XAML document links.
// These exercise path resolution, exact link ranges, exclusion rules, and malformed-input robustness.
...
describe("WinUI XAML — red-team 41 (document links)", function () {
  ...
  it("excludes prefixed elements, unlisted elements, and prefixed Source attributes", async () => {
    ...
    // Image IS linked as of round 46 (asset sources, covered positively elsewhere); MediaElement is NOT in
    // the allow-list, so it remains excluded — the guard for the allow-list boundary.
