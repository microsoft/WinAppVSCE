...
// Round 63 red-team probes for contextual parent-container attached-property name completion.
      ...
      newText: item.textEdit
        ...
        : typeof item.insertText === "string"
          ...
          : item.insertText && item.insertText.value !== undefined
            ...
            : undefined,
      // #2 attribute-name value snippet: VS Code exposes a SnippetString insertText + item.range
      // (not item.textEdit) for snippet items, so fall back to item.range for the covered span.
      range: item.textEdit
