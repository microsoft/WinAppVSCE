...
// {x:Type}/{x:Static} completion, navigation, boundaries, and malformed references.
...
describe("WinUI XAML red-team 21 — {x:Type}/{x:Static} adversarial probes", function () {
  ...
  // Mid-edit parsing resolves unterminated references while also reporting XAML0005.
  ...
  it.skip("FUTURE GAP: x:Static on user-defined static members should navigate once the fixture has one", async () => {
    // SmokePage has no static members in the fixture.
  });
});
