...
// Round 54 red-team probes for type-name completion inside x:DataType attribute values.
// Positive assertions discriminate on server-only item fields (detail/newText/range), not bare labels,
// because VS Code merges word-based suggestions from the current buffer.
