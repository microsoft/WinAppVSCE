...
describe("WinUI XAML red-team 31 — Style/ControlTemplate authoring depth", function () {
  ...
  it("completes VisualState Setter.Target from the referenced element and keeps the markup diagnostic-silent", async () => {
    ...
    // Target scopes to the REFERENCED element's type (Button), not a Style TargetType — Button's own
    // instance properties are offered (incl. inherited HorizontalAlignment), but NOT attached properties
    // and NOT the page x:Class members.
