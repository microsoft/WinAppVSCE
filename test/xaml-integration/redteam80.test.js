...
describe("WinUI XAML — red-team 80 (RelativePanel + Setter.Target references)", function () {
  ...
  // Triage hardening (author-added): edges the initial red-team pass under-covered — hover parity on the
  // Setter.Target segment, exact dot-boundary caret precision, plain Name= (no x:) declarations, distinct-
  // element rename isolation, and RelativePanel value whitespace trimming.
