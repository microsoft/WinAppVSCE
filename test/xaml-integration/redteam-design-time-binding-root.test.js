...
// Page-level classic {Binding} roots from d:DataContext. Partial names prevent VS Code word suggestions from masking server results.
...
describe("WinUI XAML — red-team 52 (design-time {Binding} rooting)", function () {
  ...
  // DesignInstance must use a prefix that resolves to a design-time namespace.
