...
| **Code actions** | Press **Ctrl+.** on an unresolved project or referenced control to import its `using:` namespace and qualify the element, add or remove namespace declarations, and apply other XAML-aware quick fixes. |
